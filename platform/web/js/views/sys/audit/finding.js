...
function nextStep(f, ctx) {
  ...
  if (c.close_blocked_sod) return nextCard({ tone: 'warn', icon: 'shieldAlert', title: L('فصل المهام: لا تعتمد إغلاق ملاحظة أثبتّها', 'Segregation of duties: you raised this finding'), body: L('يعتمد الإغلاق رئيس تدقيق آخر.', 'Another CAE must validate closure.') });
